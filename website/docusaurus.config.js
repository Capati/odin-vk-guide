...
const config = {
    ...
    tagline:
        "Practical guide to Vulkan graphics programming using Odin Language",
        ...
        [
            ...
            ({
                docs: {
                    ...
                    editUrl:
                        "https://github.com/Capati/odin-vk-guide/edit/main/website",
                },
                blog: false,
                theme: {
    ...
    themeConfig:
        ...
        rel="noopener noreferrer" href="https://github.com/just-the-docs/just-the-docs/blob/main/LICENSE.txt">MIT license</a>.`,
            ...
            prism: {
                ...
                additionalLanguages: ["odin", "bash", "hlsl"],
                magicComments: [
                    {
